...
# Fill this in after running `mind01 ask --help` and confirming the real
# flag(s) that authorize a write beyond --allow-write (e.g. --mode
# write-approved, --yes, etc). Leave empty only if --allow-write alone is
# confirmed sufficient — do not guess.
MIND01_WRITE_FLAGS=()
