...
class SemanticRouterV2:
    ...
    # FIXME: This is legacy V1 compatibility logic. It is tightly coupled to agent.py's
    # V1 execution loop and should ideally be inlined there or refactored out entirely.
    def legacy_decision(
        self,
...
# FIXME: This is legacy V1 compatibility logic used only by legacy_decision.
